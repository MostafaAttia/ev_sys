...
class EventController extends MyBaseController
{
     ...
     * @return \Illuminate\View\View
     */
    public function showCreateActivity(Request $request)
    {
        $categories = Category::lists('name', 'id')->all();
        ...
        return view('ManageOrganiser.Modals.CreateActivity', $data);
    }
    ...
    public function postCreateActivity(Request $request)
    {
        ...
        $messages = [
            ...
            'start_date.required'                  => 'You must specify the start date for your activity.',
            'end_date.required'                    => 'You must specify the end date for your activity.',
            'activity_start_time.required'         => 'You must specify the start time for your activity.',
            'activity_end_time.required'           => 'You must specify the end time for your activity.',
            'weekdays.required'                    => 'You must specify the weekdays for your activity.',
        ...
        $event->category_id = $request->get('category_id');
        $event->start_date = $request->get('start_date') ? Carbon::createFromFormat('d-m-Y H:i',
            $request->get('start_date'). ' 00:00') : null;
        ...
        $event->end_date = $request->get('end_date') ? Carbon::createFromFormat('d-m-Y H:i',
            $request->get('end_date'). ' 23:59') : null;
