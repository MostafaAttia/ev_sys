<div role="dialog"  class="modal fade" style="display: none;">
    ...
    {!! Form::open(array('url' => route('postCreateActivity'), 'class' => 'ajax gf')) !!}
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            {!! Form::label('event_image', 'Image (Flyer or Graphic etc.)', array('class'=>'control-label ')) !!}
            ...
            <div class="modal-footer">
                ...
                {!! Form::submit('Create Activity', ['class'=>"btn btn-success"]) !!}
            </div>
        </div>
        {!! Form::close() !!}
    </div>
