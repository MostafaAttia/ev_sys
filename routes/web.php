...
Route::group(['prefix' => 'client', 'middleware' => 'auth:client'], function(){
    ...
    Route::post('preferences/update/', [
        'as'    => 'updateClientPreferences',
        'uses'  => 'ClientController@updateClientPreferences',
    ]);

    Route::post('notif_prefs/update/', [
        'as'    => 'updateClientNotificationsPreferences',
        'uses'  => 'ClientController@updateClientNotificationsPreferences',
    ]);


    Route::get('/settings', [
        'as'   => 'showClientSettings',
        'uses' => 'ClientController@showClientSettings',
    ]);
 ...
 * Backend routes
 */
Route::group(['middleware' => ['auth', 'web', 'first.run']], function () {
